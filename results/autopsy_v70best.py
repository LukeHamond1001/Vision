...
SHARD = os.path.join(S, "uc_v70_eval")
...
ck = torch.load(os.path.join(S, "v70_best.pt"), map_location="cpu",
                weights_only=False)
m = HybridLM(tok.get_vocab_size(), d=384, max_T=512, store="matrix", gate_mode="position",
             use_xl=False)
