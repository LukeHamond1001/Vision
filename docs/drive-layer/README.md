> **Archived program page (moved 2026-08-21).** This is the README of the
> drive-layer campaign (v0.9–v4.0: Crafter, BoatRace, BatteryAnt) exactly as
> it was published, kept so its reproduce matrix and [AUDIT.md](AUDIT.md)
> still hold. Its module and `results/` paths are unchanged. The repository's
> centerpiece is now the language being — see the [root README](../../README.md)
> and [CENTERPIECE.md](../CENTERPIECE.md).
...
committed before runs: [docs/drive-layer/SEQUENCING.md](SEQUENCING.md).
Roadmap to robots (teleop-corpus pretraining, the teaching loop,
generational senses): [docs/drive-layer/ROBOT_PROGRAM.md](ROBOT_PROGRAM.md).
...
behavior), and the robot-substrate program in `docs/drive-layer/ROBOT_PROGRAM.md`.
